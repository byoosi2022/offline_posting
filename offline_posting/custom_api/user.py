...
def get_updates_user(doc=None, method=None, schedule_at=None):
    ...
    for server, value in response_server.items():
        if value == 1:
            ...
            url = f"https://erp.metrogroupng.com/api/resource/User?fields=[%22name%22,%22first_name%22,%22last_name%22,%22email%22,%22role_profile_name%22,%22custom_update%22]&filters={filters_user}"
...
def check_internet_user():
    try:
        ...
        # frappe.log_error(f"No Internet Available From User")
        get_updates_user()
