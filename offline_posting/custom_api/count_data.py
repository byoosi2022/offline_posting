...
def get_updates_item_count(doc=None, method=None, schedule_at=None):
    ...
    if response_customers.status_code == 200 and response_item_price.status_code == 200 and response_item.status_code == 200 and response_stock_transfer.status_code == 200 and response_reciept.status_code == 200:
        try:
            customers = set()
            items_price = set()
            items = set()
