    ...
    try:
        ...
        for server, value in response_server.items():
            if value == 1:
                ...
                url = f"https://erp.metrogroupng.com/api/resource/Stock%20Entry?filters={filters_stock_transfer}&fields=[%22name%22,%22from_warehouse%22,%22to_warehouse%22,%22company%22,%22posting_date%22,%22stock_entry_type%22,%22items.item_code%22,%22items.qty%22,%22items.basic_rate%22]"
                headers = {
...
def check_internet_purchase_receipt():
    try:
        ...
        frappe.db.commit()
        # frappe.log_error(f"Internet Available from Remote From stock_transfe ")
